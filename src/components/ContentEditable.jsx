        ...
        return (
            <div>
                <div ref={(e) => this.htmlEl = e} className={className}
                     ...
                     placeholder="Enter text here..." contentEditable="true"
                     dangerouslySetInnerHTML={{__html: html}}>
                </div>
            </div>
           );
        /*
        return (<div>{this.props.disabled ?
            <div ref={(e) => this.htmlEl = e} className={className} onInput={this.emitChange.bind(this)}
                 onBlur={this.outBox.bind(this)} placeholder="Enter text here..." contentEditable="true"
                 dangerouslySetInnerHTML={{__html: html}}></div>
            :
            <div ref={(e) => this.htmlEl = e} className={className} onClick={this.activeBox.bind(this)}
                 contentEditable="false" placeholder="Enter text here..."
                 dangerouslySetInnerHTML={{__html: htmlCache}}></div>
        }</div>);*/
    }
}
